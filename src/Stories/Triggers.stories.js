...
const data = [
    {
        ...
        "patterns": [
            "EDITest.Cassandra.*.*.DownEndpointCount.DownEndpointCount"
        ],
    ...
    },
    {
        ...
        "patterns": [
            "Billy.elasticsearch.vm-sps-nix.metrics.*.jvm.gc.collection.time"
        ],
        "is_simple_trigger": false,
        "ttl": 600,
        "warn_value": 1000.0,
    ...
    },
    {
        ...
        "ttl_state": "NODATA",
        "targets": [
            "ADK.elasticsearch.rosalco{26,27,28}.rosalco.jvm.mem.heap_used_percent"
        ],
        "patterns": [
            "ADK.elasticsearch.rosalco{26,27,28}.rosalco.jvm.mem.heap_used_percent"
        ],
    ...
    },
    {
        ...
        "expression": "",
        "targets": [
            "movingAverage(KLADR.nginx.*.upstream_response_time.total.p95, '10min')"
        ]
    },
    {
        ...
        "patterns": [
            "{Alko,EDI,EDITest,KE,KE-cloud,KE-dev}.Cassandra.*.*.GC.StopTheWorld.sum"
        ],
        "is_simple_trigger": false,
        "ttl": 1800,
    ...
    },
    {
        ...
        "expression": "",
        "targets": [
            "groupByNode(SPS.ceph.servers.*.diskspace.*.byte_avail, 3, 'sum')"
        ]
    }
]

storiesOf('Triggers', module)
    .addDecorator(StoryRouter())
    .add('Default', () => <Triggers items={data} />)
    .add('Empty', () => <Triggers items={[]} />);
